...
orbis_result = tree.xpath('//*[@id="matchedSelected"]/@data-matched')
        ...
        if orbis_result[id] == '[]' and orbis_content[id] != '[]':
            ...
            try:
                ...
                if nation == nation_popped or len(nation) == 3:
                    ...
                    print(id+page*100)
                    time.sleep(0.4)
#                    item_collapse = browser.find_element_by_xpath('//tbody/tr[@class="editRow"]/td/label')
#                    item_collapse = browser.find_element_by_css_selector('tbody > tr.editRow > td.select')
#                    item_collapse.click()
                else:
...
company_mapping = pd.DataFrame(columns=['original_name','country_code','mapped_name','mapping_score'])
